...
# Warning: this script is only for gene trees with 8 subclades!
            ...
            for species in unique_names:
                ...
                # check cases that species is present in 2 subclades
                    ...
                    if species in dict[subset_list[0]] and \
                            ...
                            species not in dict[non_subset_list[1]] and \
                            species not in dict[non_subset_list[2]] and \
                            species not in dict[non_subset_list[3]] and \
                            species not in dict[non_subset_list[4]] and \
                            species not in dict[non_subset_list[5]]:
                        # count how often species is present
                ...
                # check cases that species is present in 3 subclades
                    ...
                    if species in dict[subset_list[0]] and \
                            ...
                            species not in dict[non_subset_list[2]] and \
                            species not in dict[non_subset_list[3]] and \
                            species not in dict[non_subset_list[4]]:
                        # count how often species is present
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + dict[
                            subset_list[2]].count(species)
                        # add info to df
                        update_df(count, current_combination)

                # Check cases that species is present in 4 subclades
                elif len(subset_list) == 4:
                    # check if species is present in 4 subclades
                    if species in dict[subset_list[0]] and \
                            species in dict[subset_list[1]] and \
                            species in dict[subset_list[2]] and \
                            species in dict[subset_list[3]] and \
                            species not in dict[non_subset_list[0]] and \
                            species not in dict[non_subset_list[1]] and \
                            species not in dict[non_subset_list[2]] and \
                            species not in dict[non_subset_list[3]]:
                        # count how often species is present (this should be 4)
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + dict[
                            subset_list[2]].count(species) + dict[subset_list[3]].count(species)
                        # add info to df
                        update_df(count, current_combination)

                # Check cases that species is present in 5 subclades
                elif len(subset_list) == 5:
                    # check if species is present in all 5 subclades
                    if species in dict[subset_list[0]] and \
                            species in dict[subset_list[1]] and \
                            species in dict[subset_list[2]] and \
                            species in dict[subset_list[3]] and \
                            species in dict[subset_list[4]] and \
                            species not in dict[non_subset_list[0]] and \
                            species not in dict[non_subset_list[1]] and \
                            species not in dict[non_subset_list[2]]:
                        # count how often species is present (this should be 4)
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + \
                                dict[subset_list[2]].count(species) + dict[subset_list[3]].count(species) + \
                                dict[subset_list[4]].count(species)
                        # add info to df
                        update_df(count, current_combination)

                # Check cases that species is present in 6 subclades
                elif len(subset_list) == 6:
                    # check if species is present in all 6 subclades
                    if species in dict[subset_list[0]] and \
                            species in dict[subset_list[1]] and \
                            species in dict[subset_list[2]] and \
                            species in dict[subset_list[3]] and \
                            species in dict[subset_list[4]] and \
                            species in dict[subset_list[5]] and \
                            species not in dict[non_subset_list[0]] and \
                            species not in dict[non_subset_list[1]]:
                        # count how often species is present (this should be 4)
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + \
                                dict[subset_list[2]].count(species) + dict[subset_list[3]].count(species) + \
                                dict[subset_list[4]].count(species) + dict[subset_list[5]].count(species)
                        # add info to df
                        update_df(count, current_combination)

                # Check cases that species is present in 7 subclades
                elif len(subset_list) == 7:
                    # check if species is present in all 7 subclades
                    if species in dict[subset_list[0]] and \
                            species in dict[subset_list[1]] and \
                            species in dict[subset_list[2]] and \
                            species in dict[subset_list[3]] and \
                            species in dict[subset_list[4]] and \
                            species in dict[subset_list[5]] and \
                            species in dict[subset_list[6]] and \
                            species not in dict[non_subset_list[0]]:
                        # count how often species is present (this should be 4)
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + \
                                dict[subset_list[2]].count(species) + dict[subset_list[3]].count(species) + \
                                dict[subset_list[4]].count(species) + dict[subset_list[5]].count(species) + \
                                dict[subset_list[6]].count(species)
                        # add info to df
                        update_df(count, current_combination)

                # Check cases that species is present in 8 subclades
                elif len(subset_list) == 8:
                    # check if species is present in all 8 subclades
                    if species in dict[subset_list[0]] and \
                            species in dict[subset_list[1]] and \
                            species in dict[subset_list[2]] and \
                            species in dict[subset_list[3]] and \
                            ...
                            species in dict[subset_list[5]] and \
                            species in dict[subset_list[6]] and \
                            species in dict[subset_list[7]]:
                        # count how often species is present (this should be 4)
                        count = dict[subset_list[0]].count(species) + dict[subset_list[1]].count(species) + \
                                dict[subset_list[2]].count(species) + dict[subset_list[3]].count(species) + \
                                dict[subset_list[4]].count(species) + dict[subset_list[5]].count(species) + \
                                dict[subset_list[6]].count(species) + dict[subset_list[7]].count(species)
                        # add info to df
                        update_df(count, current_combination)
